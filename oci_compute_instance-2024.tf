resource "oci_core_instance" "instance-2024" {
  async                      = null
  ...
  defined_tags = {
    ...
    "Oracle-Tags.CreatedOn" = "2024-07-15T21:59:34.788Z"
  }
  display_name                        = "instance-20240716-0649"
  extended_metadata                   = {}
  ...
  create_vnic_details {
    ...
    defined_tags = {
      "Oracle-Tags.CreatedBy" = "default/shion1305@gmail.com"
      "Oracle-Tags.CreatedOn" = "2024-07-15T21:59:34.924Z"
    }
    display_name           = "instance-20240716-0649"
    freeform_tags          = {}
    hostname_label         = "instance-20240716-0649"
    nsg_ids                = []
